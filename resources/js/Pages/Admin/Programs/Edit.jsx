...
export default function Edit({ program }) {
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Edit Program</h2>}
        >
                    ...
                    <form onSubmit={handleSubmit}>
                        <Card>
                            ...
                            <CardContent className="space-y-6">
                                ...
                                {/* Program Statistics */}
                                {program.applications_count !== undefined && (
                                    <div className="bg-gray-50 p-4 rounded-lg">
                                        <h4 className="font-medium text-gray-900 mb-2">Program Statistics</h4>
                                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                            <div>
                                                <p className="text-sm text-gray-500">Total Applications</p>
                                                <p className="text-lg font-semibold">{program.applications_count || 0}</p>
                                            </div>
                                            <div>
                                                <p className="text-sm text-gray-500">Pending</p>
                                                <p className="text-lg font-semibold">{program.pending_count || 0}</p>
                                            </div>
                                            <div>
                                                <p className="text-sm text-gray-500">Accepted</p>
                                                <p className="text-lg font-semibold">{program.accepted_count || 0}</p>
                                            </div>
                                            <div>
