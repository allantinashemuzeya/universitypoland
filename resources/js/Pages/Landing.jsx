    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-white">
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex justify-between h-20">
                            <div className="flex items-center">
                                <h1 className="text-2xl font-display font-bold text-red-700">
                                    Nexus Study
                                </h1>
                            </div>
                            <div className="hidden md:flex items-center space-x-8">
                                <a href="#programs" className="text-dark-700 hover:text-red-600 transition">Programs</a>
                                <a href="#about" className="text-dark-700 hover:text-red-600 transition">About</a>
                                <Link href={route('resources')} className="text-dark-700 hover:text-red-600 transition">Life in Poland</Link>
                                <a href="#apply" className="text-dark-700 hover:text-red-600 transition">Apply</a>
                                {auth.user ? (
                                    <Link
                                    ...
                                    <div className="flex items-center space-x-4">
                                        <Link
                                            href={route('login')}
                                            className="text-dark-700 hover:text-red-600 transition font-medium"
                                        >
                                            Login
                                        </Link>
                                        <Link
                    ...
                    {mobileMenuOpen && (
                        <div className="md:hidden bg-white border-t">
                            <div className="px-2 pt-2 pb-3 space-y-1">
                                <a href="#programs" className="block px-3 py-2 text-dark-700 hover:text-red-600">Programs</a>
                                <a href="#about" className="block px-3 py-2 text-dark-700 hover:text-red-600">About</a>
                                <a href="#life-in-poland" className="block px-3 py-2 text-dark-700 hover:text-red-600">Life in Poland</a>
                                <a href="#apply" className="block px-3 py-2 text-dark-700 hover:text-red-600">Apply</a>
                                {!auth.user && (
                                    <>
                                        <Link href={route('login')} className="block px-3 py-2 text-dark-700 hover:text-red-600">Login</Link>
                                        <Link href={route('register')} className="block px-3 py-2 bg-red-600 text-white rounded-lg text-center">Apply Now</Link>
                                    </>
                                )}
                            </div>
                        </div>
                                    ...
                                    <div key={program.id} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition">
                                        ...
                                        <div className="p-6">
                                            ...
                                            <p className="text-gray-600 mb-4 line-clamp-3">
                                                {program.description || 'Join our internationally recognized program designed to prepare you for global career opportunities.'}
                                            </p>
                                    ...
                                    <div key={index} className={`relative flex items-center mb-12 ${index % 2 === 0 ? 'flex-row-reverse' : ''}`}>
                                        <div className={`w-1/2 ${index % 2 === 0 ? 'pl-8 text-right' : 'pr-8'}`}>
                                            <div className="bg-white p-6 rounded-lg shadow-lg">
                                                ...
                                                <span className="text-red-600 font-medium">{item.duration}</span>
                                            </div>
                                        </div>
                ...
                <section className="py-20 bg-white">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                            <Link 
                                href={route('resources')} 
                                className="bg-gradient-to-br from-red-50 to-red-100 p-6 rounded-lg hover:shadow-lg transition group"
                            >
                                ...
                                <h4 className="text-lg font-semibold text-dark-900 mb-2 group-hover:text-red-600 transition">Visa Guide</h4>
                ...
                {/* CTA Section */}
                <section id="apply" className="py-20 bg-gradient-to-r from-red-600 to-red-800">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link
                                href={route('register')}
                                className="bg-white text-red-700 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-gray-100 transition inline-block"
                            >
                                Apply Now
                            </Link>
                            <a
                                href="#programs"
                                className="border-2 border-white text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-white hover:text-red-700 transition inline-block"
                            >
                                View Programs
                            </a>
                        </div>
